module.exports = {
    ...
    execute(message, args, fs, opt){
        ...
        if(mention && mention.id != '856738757332041728'){
            ...
            if(opt.indexOf(mention.id) != -1) return;
        ...
        switch(rand){
            ...
            case 3:
                ...
                break;
            case 4:
                message.channel.send(user + ', Find and complete a task on writeforme. Ignore if busy');
                break;
            case 5:
            ...
            case 21:
                ...
                break;
            case 22:
                message.channel.send(user + ', You are a cute Drone~');
                break;
        }
    }
}
